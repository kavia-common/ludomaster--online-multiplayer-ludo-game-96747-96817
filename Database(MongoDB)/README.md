...
The backend should import the Database(MongoDB)/src/db/connection.js module to get a connected MongoClient and db instance. Models in Database(MongoDB)/src/models/* provide typed accessors and common operations.
...
const { getDb } = require('../Database(MongoDB)/src/db/connection');
